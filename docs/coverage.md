...
| **Judgement where data is thin**<br><sub>Assumption status gate, disputed route quarantine, an unverifiable O-D share bounded rather than asserted, and ten documented changes of mind</sub> | `data/manual/assumptions.csv`<br>`src/data_pipeline.py`<br>`docs/pivot_log.md` | yes |
